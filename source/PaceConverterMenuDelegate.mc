...
class SettingsMenuDelegate extends WatchUi.Menu2InputDelegate {
    ...
    function onSelect(item as WatchUi.MenuItem) as Void {
        ...
        // PATH 2: Add New Distance (Using the new Custom Picker)
            ...
            WatchUi.pushView(distPicker, new DistancePickerDelegate(distPicker), WatchUi.SLIDE_LEFT);
        } 
        ...
        // PATH 3: Edit Distance List (Delete)
            ...
            for (var i = 0; i < dists.size(); i++) {
                ...
                var label = (d >= 1000) ? (d/1000.0).format("%.1f") + "km" : d + "m";
                // We use the index 'i' as the ID for deletion
                editMenu.addItem(new WatchUi.MenuItem(label, "Tap to Remove", i, {}));
            }
            WatchUi.pushView(editMenu, new ManageDistancesDelegate(), WatchUi.SLIDE_LEFT);
        }
    }
